...
export default function LandingPage() {
  ...
  const T = {
    th: {
      hero_title:   "AI ช่วยคัดกรองและวิเคราะห์หุ้นสหรัฐฯ",
      hero_sub:     "สำหรับผู้สนใจตลาดหุ้นสหรัฐฯ\nค้นหา เปรียบเทียบ และสรุปข้อมูลบริษัทด้วย AI เพื่อการศึกษาและการวิจัย",
      cta_start:    "เริ่มใช้งานฟรี",
      cta_demo:     "ดูตัวอย่าง Dashboard",
      badge:        "AI Research Platform สำหรับหุ้นสหรัฐฯ",
      problem_title:"ข้อมูลหุ้นสหรัฐฯ ที่หาได้ยาก — AI ช่วยได้",
      p1_title:     "ข้อมูลมหาศาล ไม่รู้จะเริ่มดูจากตรงไหน",
      p1_desc:      "หุ้นสหรัฐฯ มีมากกว่า 8,000 ตัว การคัดกรองด้วยตนเองต้องใช้เวลาหลายชั่วโมงต่อวัน",
